...
"")
        ...
        self.frame_Usuario = QtWidgets.QFrame(self.frame_GestorP)
        self.frame_Usuario.setGeometry(QtCore.QRect(0, 0, 1061, 581))
        ...
        self.line_3 = QtWidgets.QFrame(self.frame_Usuario)
        self.line_3.setGeometry(QtCore.QRect(27, 40, 1011, 20))
        self.line_3.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_3.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_3.setObjectName("line_3")
        self.label_DatosUsuario = QtWidgets.QLabel(self.frame_Usuario)
        self.label_DatosUsuario.setGeometry(QtCore.QRect(40, 10, 241, 31))
        self.label_DatosUsuario.setObjectName("label_DatosUsuario")
        self.boton_RegistrarUsuario = QtWidgets.QPushButton(self.frame_Usuario)
        self.boton_RegistrarUsuario.setGeometry(QtCore.QRect(460, 510, 131, 41))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        self.boton_RegistrarUsuario.setFont(font)
        self.boton_RegistrarUsuario.setStyleSheet("background-color: rgb(179, 179, 179);\n"
"border-style: solid;\n"
"border-radius:15px;\n"
"")
        self.boton_RegistrarUsuario.setObjectName("boton_RegistrarUsuario")
        self.lineEdit_NombreUsuario = QtWidgets.QLineEdit(self.frame_Usuario)
        self.lineEdit_NombreUsuario.setGeometry(QtCore.QRect(50, 110, 921, 31))
        self.lineEdit_NombreUsuario.setObjectName("lineEdit_NombreUsuario")
        self.label_4 = QtWidgets.QLabel(self.frame_Usuario)
        self.label_4.setGeometry(QtCore.QRect(50, 77, 161, 20))
        self.label_4.setObjectName("label_4")
        self.line_4 = QtWidgets.QFrame(self.frame_Usuario)
        self.line_4.setGeometry(QtCore.QRect(30, 150, 1011, 20))
        self.line_4.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_4.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_4.setObjectName("line_4")
        self.label_IDUsuario = QtWidgets.QLabel(self.frame_Usuario)
        self.label_IDUsuario.setGeometry(QtCore.QRect(50, 180, 161, 20))
        self.label_IDUsuario.setObjectName("label_IDUsuario")
        self.lcdNumber = QtWidgets.QLCDNumber(self.frame_Usuario)
        self.lcdNumber.setGeometry(QtCore.QRect(50, 210, 261, 61))
        self.lcdNumber.setObjectName("lcdNumber")
        self.line_5 = QtWidgets.QFrame(self.frame_Usuario)
        self.line_5.setGeometry(QtCore.QRect(30, 290, 1011, 20))
        self.line_5.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_5.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_5.setObjectName("line_5")
        self.label_Ocupacion = QtWidgets.QLabel(self.frame_Usuario)
        self.label_Ocupacion.setGeometry(QtCore.QRect(50, 320, 161, 20))
        self.label_Ocupacion.setObjectName("label_Ocupacion")
        self.lineEdit_OcupacionUsuario = QtWidgets.QLineEdit(self.frame_Usuario)
        self.lineEdit_OcupacionUsuario.setGeometry(QtCore.QRect(50, 350, 921, 31))
        self.lineEdit_OcupacionUsuario.setObjectName("lineEdit_OcupacionUsuario")
        self.line_6 = QtWidgets.QFrame(self.frame_Usuario)
        self.line_6.setGeometry(QtCore.QRect(30, 400, 1011, 20))
        self.line_6.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_6.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_6.setObjectName("line_6")
        self.label_Correo = QtWidgets.QLabel(self.frame_Usuario)
        self.label_Correo.setGeometry(QtCore.QRect(50, 430, 161, 20))
        self.label_Correo.setObjectName("label_Correo")
        self.lineEdit_CorreoUsuario = QtWidgets.QLineEdit(self.frame_Usuario)
        self.lineEdit_CorreoUsuario.setGeometry(QtCore.QRect(50, 460, 921, 31))
        self.lineEdit_CorreoUsuario.setObjectName("lineEdit_CorreoUsuario")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_DatosUsuario.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:16pt; font-weight:600;\">Datos del Usuario</span></p></body></html>"))
        self.boton_RegistrarUsuario.setText(_translate("MainWindow", "Registar"))
        self.label_4.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt;\">Nombres y Apellidos</span></p></body></html>"))
        self.label_IDUsuario.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt;\">Identificador</span></p></body></html>"))
        self.label_Ocupacion.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt;\">Ocupación</span></p></body></html>"))
        self.label_Correo.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt;\">Correo</span></p></body></html>"))
